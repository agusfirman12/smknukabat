...
<div class="container">
    <div class="container border-bottom">
        <div class="row d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-2">
            ...
            <div class="col">
                <a href="/admin/post" class="btn btn-success"><i class="bi bi-arrow-left"></i>Kembali</a>
                <a href="/admin/post/{{ $post->id }}/edit" class="btn btn-warning"><i class="bi bi-pencil-square"></i>Edit</a>
